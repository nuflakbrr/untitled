...
export const AboutCta = () => (
  <section className="px-4 pb-20 sm:px-6 sm:pb-24">
    <div className="relative mx-auto flex max-w-295 flex-col items-start justify-between gap-7 overflow-hidden rounded-[30px] bg-[#ff7a45] p-7 text-white sm:p-10 lg:flex-row lg:items-center lg:p-12">
      ...
      <div className="relative z-10">
        ...
        <p className="mt-3 max-w-145 text-base leading-relaxed text-white/80">
          Temukan event dengan SITIVENT untuk membuat perjalanan acara terasa lebih sederhana.
        </p>
      </div>
      <Link
        href="/events"
        className="relative z-10 inline-flex shrink-0 group items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-bold text-[#11233f] transition hover:-translate-y-0.5"
      >
        Jelajahi Event{' '}
