...
export default function PrivacyPolicy() {
  return (
    <LegalPageLayout
      title="Kebijakan Privasi"
      description="Gambaran tentang bagaimana informasi pengguna dipakai, dilindungi, dan dikelola ketika menggunakan SITIVENT."
      lastUpdated={process.env.PRIVACY_LAST_UPDATED ?? '12 Juli 2026'}
      noticeTitle="Privasi adalah bagian dari pengalaman SITIVENT"
