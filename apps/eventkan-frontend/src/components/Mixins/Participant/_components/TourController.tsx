...
export function TourController() {
  ...
  return (
    <button type="button" onClick={() => { setCurrentStep(0); setIsOpen(true); }} className="group fixed bottom-6 right-6 z-40 flex cursor-pointer items-center gap-2.5 rounded-full bg-eventkan-accent p-3.5 text-xs font-medium text-white shadow-[0_12px_30px_rgba(255,122,69,.22)] transition-all duration-300 hover:scale-105 hover:bg-eventkan-accent-hover sm:text-sm" title="Panduan Portal Peserta" aria-label="Panduan Portal Peserta">
