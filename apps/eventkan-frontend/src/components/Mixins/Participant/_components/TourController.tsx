...
export function TourController() {
  ...
  return (
    <button type="button" onClick={() => { setCurrentStep(0); setIsOpen(true); }} className="group fixed bottom-6 right-6 z-40 flex cursor-pointer items-center gap-2.5 rounded-full bg-[#11233f] p-3.5 text-xs font-medium text-white shadow-[0_12px_30px_rgba(17,35,63,.18)] transition-all duration-300 hover:scale-105 hover:bg-[#1b3458] sm:text-sm" title="Panduan Portal Peserta" aria-label="Panduan Portal Peserta">
