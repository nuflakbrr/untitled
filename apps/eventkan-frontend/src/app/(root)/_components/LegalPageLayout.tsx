  ...
  <div className="min-h-screen bg-[#f6f3eb] font-sans text-[#111927] antialiased">
    <section className="px-4 pb-12 pt-16 sm:px-6 lg:pb-16 lg:pt-20">
      <div className="mx-auto max-w-295">
        ...
        <p className="mt-5 max-w-180 text-lg leading-relaxed text-[#6c7280]">{description}</p>
      ...
      <div className="mx-auto grid max-w-295 grid-cols-1 items-start gap-7 lg:grid-cols-[minmax(230px,.34fr)_minmax(0,1fr)]">
        ...
        <article className="rounded-[28px] border border-[#111927]/10 bg-[#fffdf8] p-6 shadow-[0_16px_45px_rgba(17,35,63,.05)] sm:p-8 lg:p-13">
          <div className="mb-8 rounded-[18px] border border-[#ff7a45]/20 bg-[#ffe5d8] p-5 text-sm leading-relaxed text-[#6c7280]">
            <strong className="font-display mb-1 block text-[#11233f]">{noticeTitle}</strong>
            {notice}
          </div>
          ...
          <div className="mt-8 flex flex-col items-start justify-between gap-5 rounded-[20px] bg-[#bfe4c7] p-6 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-[#11233f]/65">{ctaDescription}</p>
            </div>
            <Link
              href="/help"
              className="group inline-flex shrink-0 items-center gap-2 rounded-full bg-[#11233f] px-4.5 py-3 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#1b3458]"
            >
              Pusat Bantuan{' '}
          ...
          <div className="mt-6">
            <Link
              href="/"
              className="group inline-flex items-center gap-2 rounded-full border border-[#11233f] px-4.5 py-3 text-sm font-bold text-[#11233f] transition hover:bg-[#11233f] hover:text-white"
            >
