...
const CTABanner: FC = () => (
  <section className="px-4 pb-24 pt-8 sm:px-6">
    <div className="relative mx-auto max-w-295 overflow-hidden rounded-[34px] bg-eventkan-accent px-7 py-18 text-white sm:px-18 before:absolute before:-right-27.5 before:-top-30 before:h-95 before:w-95 before:rounded-full before:border-76 before:border-white/12">
      <h2
      ...
      <Link
        href="/events"
        className="group relative z-10 mt-7 inline-flex items-center gap-2 rounded-full border border-white bg-white px-4.5 py-3 font-bold text-eventkan-navy transition hover:-translate-y-0.5 hover:bg-white"
      >
