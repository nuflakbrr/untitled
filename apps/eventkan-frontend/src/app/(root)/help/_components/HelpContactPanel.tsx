...
const HelpContactPanel: FC = () => (
  <div className="relative overflow-hidden rounded-[28px] bg-eventkan-navy p-6 text-white sm:p-8 lg:sticky lg:top-28">
    {/* <div className="pointer-events-none absolute -right-18 -top-18 h-52 w-52 rounded-full border-28 border-white/10" />
    <div className="pointer-events-none absolute -bottom-20 -left-14 h-48 w-48 rounded-full bg-eventkan-accent/25 blur-2xl" /> */}
    ...
    <div className="relative z-10">
      ...
      <div className="mt-8 grid gap-3">
        ...
        >
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-eventkan-accent text-white">
        ...
        <a
          ...
          className="flex items-start gap-3 rounded-[18px] border border-white/10 bg-white/8 p-4 transition hover:bg-white/12"
        >
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-eventkan-green text-eventkan-navy">
        ...
        <div className="flex items-start gap-3 rounded-[18px] border border-white/10 bg-white/8 p-4">
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-eventkan-yellow text-eventkan-navy">
