...
export const faqItems: FAQItem[] = [
  {
    id: 'apa-itu-eventkan',
    category: 'umum',
    question: 'Apa itu EVENTKAN?',
    answer:
      'EVENTKAN adalah platform manajemen dan pencarian event terintegrasi yang memudahkan penyelenggara untuk mempublikasikan, mengelola pendaftaran, dan mendistribusikan tiket event, serta membantu peserta menemukan berbagai event menarik seperti seminar, workshop, webinar, dan kompetisi.',
  },
  {
    id: 'apakah-daftar-gratis',
    category: 'umum',
    question: 'Apakah mendaftar di EVENTKAN gratis?',
    answer:
      'Ya, pendaftaran akun untuk peserta maupun penyelenggara di EVENTKAN sepenuhnya gratis tanpa biaya bulanan atau biaya tersembunyi.',
  },
  {
  ...
  },
  {
    ...
    category: 'pembayaran',
    question: 'Metode pembayaran apa saja yang didukung oleh EVENTKAN?',
    answer:
