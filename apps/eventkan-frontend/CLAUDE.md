...
EVENTKAN is a Next.js application built with **PBAC (Permission-Based Access Control)** architecture. Focus on client-facing components with **Common** (atomic) and **Mixins** (composite) component patterns.
