...
import (
	...
	"eventkan-backend/internal/modules/core/tenant/domain"
	"eventkan-backend/internal/modules/core/tenant/dto"
	"eventkan-backend/internal/modules/core/tenant/repository"
	"eventkan-backend/internal/modules/core/tenant/service"
...
func (h *TenantHandler) Delete(c *gin.Context) {
	...
	if tenant.Type == string(domain.TenantTypeRoot) {
		response.Error(c, http.StatusForbidden, "Root tenant cannot be deleted", "")
		return
	}
