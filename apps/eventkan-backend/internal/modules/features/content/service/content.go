...
import (
	...
	"eventkan-backend/internal/modules/features/content/domain"
	"eventkan-backend/internal/modules/features/content/dto"
	"eventkan-backend/internal/modules/features/content/repository"
)
...
func (s *ContentService) RestoreArticle(ctx context.Context, id string, scope *string) error {
	return s.articles.(*repository.ArticleRepository).Restore(ctx, id, scope)
}
func (s *ContentService) PermanentDeleteArticle(ctx context.Context, id string, scope *string) error {
	return s.articles.(*repository.ArticleRepository).PermanentDelete(ctx, id, scope)
}
...
func (s *ContentService) ListCategoriesWithDeleted(ctx context.Context) ([]dto.CategoryResponse, error) {
	items, err := s.categories.(*repository.CategoryRepository).FindAllWithDeleted(ctx)
	if err != nil {
		return nil, err
	}
	result := make([]dto.CategoryResponse, 0, len(items))
	for _, item := range items {
		result = append(result, toCategoryResponse(item))
	}
	return result, nil
}
...
func (s *ContentService) RestoreCategory(ctx context.Context, id string) error {
	return s.categories.(*repository.CategoryRepository).Restore(ctx, id)
}
func (s *ContentService) PermanentDeleteCategory(ctx context.Context, id string) error {
	return s.categories.(*repository.CategoryRepository).PermanentDelete(ctx, id)
}
...
func (s *ContentService) GetGalleryByID(ctx context.Context, id string) (*dto.GalleryResponse, error) {
	gallery, err := s.galleries.FindByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (s *ContentService) RestoreGallery(ctx context.Context, id string, scope *string) error {
	return s.galleries.(*repository.GalleryRepository).Restore(ctx, id, scope)
}
func (s *ContentService) PermanentDeleteGallery(ctx context.Context, id string, scope *string) error {
	return s.galleries.(*repository.GalleryRepository).PermanentDelete(ctx, id, scope)
}
...
func toArticleResponse(article *domain.Article) dto.ArticleResponse {
	return dto.ArticleResponse{
		...
		Cover: article.Cover, Slug: article.Slug, CreatedByID: article.CreatedByID, CreatedByName: article.CreatedByName, CategoryIDs: article.CategoryIDs,
...
func toCategoryResponse(category *domain.ArticleCategory) dto.CategoryResponse {
	return dto.CategoryResponse{ID: category.ID, Name: category.Name, CreatedAt: category.CreatedAt, UpdatedAt: category.UpdatedAt, DeletedAt: category.DeletedAt}
}
