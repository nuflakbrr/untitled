...
('47def472-fd2a-431c-b842-e3c200e7e90f', 'superadmin.univ@eventkan.ac.id', 'credential', '48e8167e-0105-4242-b6db-9bb12dc84bce', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('86b4322b-ea61-4ef6-8635-349d5d0150fb', 'superadmin.fasilkom@eventkan.ac.id', 'credential', '355f936d-e2b6-4ed3-8385-455115f605a3', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('af46b3ca-fbf3-4904-9e37-311992f8a907', 'superadmin.teknik@eventkan.ac.id', 'credential', '8d0f1b93-ecf3-4488-851f-343defd33246', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('2182b055-5ada-4653-9b1d-c545e25def59', 'superadmin.feb@eventkan.ac.id', 'credential', '81537a6d-d297-450b-ab75-5b8a888842f2', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('92076eae-79c5-45d8-a05e-2cdadc29ddcf', 'panitia.fasilkom@eventkan.ac.id', 'credential', 'f01e763a-5729-4734-a40e-61b6b16f7450', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('99a9fe9a-bd7b-429a-991e-57e150b342a9', 'panitia.teknik@eventkan.ac.id', 'credential', 'd04410fc-542d-43a2-b9d0-90b3ad6e5b8a', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('2ba5415e-f0dc-406a-ae57-8d9945a445f8', 'scanner.fasilkom@eventkan.ac.id', 'credential', '0702c5aa-dfd8-4908-aa4e-9a5f54c981f7', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('0fdd243b-3e5b-42be-986b-f1d0bbd0301b', 'scanner.teknik@eventkan.ac.id', 'credential', 'ef0ff24e-68d1-4713-aeb6-b7f61af6e761', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
('b2662f61-191a-4418-b0e4-1a9aa302dca0', 'peserta@eventkan.ac.id', 'credential', '4dcf1bcc-9f81-49bf-a1d4-41031ca97187', '$2a$10$NGxjuqFCFKt4tN426NnTDuQdoKEJtl4oFfUeIWtENxG9whD4nbePO', NOW(), NOW()),
...
UPDATE core.users
SET email = regexp_replace(email, '@eventkan\.ac\.id$', '@gmail.com')
WHERE email LIKE '%@eventkan.ac.id';
