...
```json
{
  ...
  "full_name": "John Doe",
  "company_id": "660e8400-...",
  "company_name": "PT EVENTKAN Indonesia",
  "client_id": "770e8400-...",
  "client_slug": "eventkan",
...
| `iss` | string | Selalu `"eventkan-api"` |
...
```json
{
  "data": {
    ...
    "user": {
      ...
      "username": "admin",
      "full_name": "Admin EVENTKAN"
    },
    "company": {
      "id": "660e8400-...",
      "name": "PT EVENTKAN Indonesia"
    },
    "client": {
      "id": "770e8400-...",
      "slug": "eventkan",
  ...
  "data": [
    {
      ...
      "name": "PT EVENTKAN Indonesia",
      "type": "holding",
      "logo_url": "https://cdn.example.com/logos/eventkan-id.png",
      "parent_id": null,
      "is_primary": true,
      "is_owner": true,
...
3. Set **Authorized domains** untuk semua domain FE (mis. `app.eventkan.id`, `localhost` untuk dev).
