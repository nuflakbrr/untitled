...
```json
{
  ...
  "full_name": "John Doe",
  "company_id": "660e8400-...",
  "company_name": "PT Untitled Indonesia",
  "client_id": "770e8400-...",
  "client_slug": "untitled",
...
| `iss` | string | Selalu `"untitled-api"` |
...
```json
{
  "data": {
    ...
    "user": {
      "id": "550e8400-...",
      "email": "admin@untitled.com",
      "username": "admin",
      "full_name": "Admin Untitled"
    },
    "company": {
      "id": "660e8400-...",
      "name": "PT Untitled Indonesia"
    },
    "client": {
      "id": "770e8400-...",
      "slug": "untitled",
  ...
  "data": [
    {
      ...
      "name": "PT Untitled Indonesia",
      "type": "holding",
      "logo_url": "https://cdn.example.com/logos/untitled-id.png",
      "parent_id": null,
      "is_primary": true,
      "is_owner": true,
...
3. Set **Authorized domains** untuk semua domain FE (mis. `app.untitled.id`, `localhost` untuk dev).
