...
CREATE INDEX IF NOT EXISTS idx_audit_logs_tenant_id ON core.audit_logs(tenant_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_entity ON core.audit_logs(entity, entity_id);
