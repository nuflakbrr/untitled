...
```json
{
  ...
  "full_name": "John Doe",
  "company_id": "660e8400-...",
  "company_name": "PT SITIVENT Indonesia",
  "client_id": "770e8400-...",
  "client_slug": "sitivent",
...
| `iss` | string | Selalu `"sitivent-api"` |
...
```json
{
  "data": {
    ...
    "user": {
      "id": "550e8400-...",
      "email": "admin@sitivent.com",
      "username": "admin",
      "full_name": "Admin SITIVENT"
    },
    "company": {
      "id": "660e8400-...",
      "name": "PT SITIVENT Indonesia"
    },
    "client": {
      "id": "770e8400-...",
      "slug": "sitivent",
  ...
  "data": [
    {
      ...
      "name": "PT SITIVENT Indonesia",
      "type": "holding",
      "logo_url": "https://cdn.example.com/logos/sitivent-id.png",
      "parent_id": null,
      "is_primary": true,
      "is_owner": true,
...
3. Set **Authorized domains** untuk semua domain FE (mis. `app.sitivent.id`, `localhost` untuk dev).
