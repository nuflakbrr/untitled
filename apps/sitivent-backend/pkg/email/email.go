...
type EmailService interface {
	...
	SendNewsletterConfirmation(to string) error
}
...
func (s *NoOpEmailService) SendNewsletterConfirmation(to string) error {
	fmt.Printf("[NoOpEmail] Newsletter confirmation to %s\n", to)
	return nil
}
