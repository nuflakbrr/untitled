# Email Architecture & Queue - EVENTKAN (EVENTKAN Monorepo)
...
- `SMTP_FROM_EMAIL`: Alamat email pengirim (contoh: `noreply@eventkan.com`).
- `SMTP_FROM_NAME`: Nama pengirim (contoh: `"EVENTKAN"`).
