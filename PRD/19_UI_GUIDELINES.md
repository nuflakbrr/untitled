# UI/UX & Design Guidelines - EVENTKAN (EVENTKAN Monorepo)
...
2. **Dukungan Tema Terang & Gelap (Dark & Light Mode)**:
   - Warna palette tema dikonfigurasi secara tersentralisasi di `apps/eventkan-frontend/src/theme/core/palette.ts`.
