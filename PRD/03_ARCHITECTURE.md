# Architecture Principles & Design - EVENTKAN (EVENTKAN Monorepo)
...
2. **Polyglot Monorepo Separation**:
   ...
   - `apps/eventkan-frontend/`: Aplikasi antarmuka berbasis **Next.js 16 (React 19)** yang melayani portal publik, dashboard admin panitia fakultas/rektorat, dan dashboard peserta mandiri.
...
### A. Next.js 16 Route Groups (`apps/eventkan-frontend/src/app/`)
