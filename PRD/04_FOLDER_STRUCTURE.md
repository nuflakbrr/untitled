# Folder Structure - EVENTKAN (EVENTKAN Monorepo)

> **Version**: 1.0.0  
> **Monorepo Layout**: Turborepo, `apps/backend/` (Go Gin REST API), `apps/eventkan-frontend/` (Next.js 16 App Router), `packages/` (Shared Packages)
