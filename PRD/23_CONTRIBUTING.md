# Contributing & Development Workflow - EVENTKAN (EVENTKAN Monorepo)
...
- **Mematuhi Arsitektur Monorepo**: Menempatkan kode backend di `apps/backend/` dan antarmuka di `apps/eventkan-frontend/`.
